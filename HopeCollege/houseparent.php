  ...
  <div class="login-box">
    ...
    <div class="form-group" style="margin-bottom:1.25rem">
      ...
      <div class="pw-wrap">
        ...
        <span class="pw-toggle" onclick="togglePw('hpLoginPass',this)" role="button" aria-label="Show password" tabindex="0">👁</span>
      </div>
    </div>
        ...
        <div class="form-card" style="max-width:480px">
          ...
          <div class="form-group" style="margin-bottom:12px">
            ...
            <div class="pw-wrap">
              ...
              <span class="pw-toggle" onclick="togglePw('hpNewPass',this)" role="button" aria-label="Show password" tabindex="0">👁</span>
            </div>
          </div>
          <div class="form-group" style="margin-bottom:1.25rem">
            ...
            <div class="pw-wrap">
              ...
              <span class="pw-toggle" onclick="togglePw('hpCurPass',this)" role="button" aria-label="Show password" tabindex="0">👁</span>
            </div>
          </div>
...
function renderHpStudents() {
  ...
  var filtered = hpStudents.filter(function(s) {
    ...
    var searchText = (s.first_name+' '+s.last_name+' '+(s.student_class||'')+' '+parentText).toLowerCase();
...
function hpExportStudents() {
  ...
  var h = 'Name,Class,Status,Parents\n';
  var rows = hpStudents.map(function(s){
    ...
    return '"'+s.first_name+' '+s.last_name+'","'+(s.student_class||'')+'","'+(s.on_campus?'On Campus':'Off Campus')+'","'+parentInfo+'"';
  }).join('\n');
  var a=document.createElement('a');
