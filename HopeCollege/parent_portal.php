...
function updateBadges() {
  ...
  // New announcements badge (all, since parent can't "mark read")
  var annCount = (_portalData.announcements || []).length;
  var ab = document.getElementById('psb-ann-badge');
  if (annCount > 0) { ab.textContent = annCount; ab.style.display = 'inline-block'; }
