...
<div class="hero">
  ...
  <h1>Welcome to <em>Hope College</em></h1>
  <p style="margin-bottom:.5rem">A seamless platform connecting parents, students, and school administration — from registration to attendance.</p>
  <!-- ✅ SCHOOL MOTTO displayed in hero -->
  <p style="font-size:.9rem;font-style:italic;color:rgba(56,189,248,.90);margin-bottom:1.75rem;">
    &ldquo;Character &bull; Scholarship &bull; Service &bull; Leadership&rdquo; &mdash; Gomoah Fetteh, Ghana
  </p>
  <div class="hero-btns">
